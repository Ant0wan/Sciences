...
> *Exemple : H₂O (eau), CO₂ (dioxyde de carbone), CH₄ (méthane).*
...
> *Exemples : point de fusion, couleur, conductivité électrique, densité, dureté.*
...
> *Exemples : l'or (Au) est une substance élémentaire ; l'eau (H₂O) est une substance composée.*
...
> *Exemples : oxygène (O), carbone (C), fer (Fe), azote (N), cuivre (Cu).*
